...
public class Hexagon extends HexComponent {
	...
	public static enum HexType {
		WALL, START, END, EMPTY, START_PROCESSED, END_PROCESSED, START_DEQUEUED, ENQUEUED, DEQUEUED, DRAGON, LAVA, CACTI, PATH,Demo
	};
	...
	public void setDemo(){
		this.setBackground(HexColors.Demo);
	}
	 ...
	 */
	public void setColor(HexType t) {
